...
// last created on 2021-05-16 15:08:17
/*
...
if (ini_get('sendmail_path')) {
    ...
    \define('SENDMAILCOMMAND', 'NoMailCmd');    // kein Mailing über php möglich
}
\define('debsmall', 1);
...
array_insert($GLOBALS['BE_MOD'], 1, ['formdata' => []]);

// this is used for the form independent "Feedback" module
$GLOBALS['BE_MOD']['formdata']['feedback'] = [
    'tables' => ['tl_formdata', 'tl_formdata_details'],
...
$GLOBALS['BE_MOD']['formdata']['fd_mytestformular-do'] = [
    'tables' => ['tl_formdata', 'tl_formdata_details'],
    'import' => ['FormdataBackend', 'importCsv'],
    'icon' => 'bundles/contaoefgco4/icons/formdata_all.gif',
    'stylesheet' => 'bundles/contaoefgco4/css/style.css', ];
