...
$GLOBALS['TL_LANG']['tl_module']['efg_iconfolder'] = ['Verzeichnis der Icons', 'Tragen Sie hier das Verzeichnis Ihrer Icons ein. Falls das Feld nicht ausgefüllt wird, werden die Icons im Verzeichnis "system/modules/efg_co4/assets/" verwendet.'];
