...
$GLOBALS['TL_LANG']['tl_module']['efg_iconfolder'] = ['Icons folder', 'Give in the directory containing your icons. If left blank the icons in folder "system/modules/efg_co4/assets/" will be used.'];
