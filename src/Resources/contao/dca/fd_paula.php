...
// last created on 2021-03-03 14:13:04 by saving form "Paula"



/**
 * Table tl_formdata defined by form "Paula"
 */
...
(
	...
	<div class="fd_head">%s<span>[%s]</span><span>%s</span></div>
		<div class="fd_notes">%s</div>
			...
			/*
			'label_callback'          => array('tl_fd_paula','getRowLabel')
			*/
		),
 ...
 */
if (!class_exists('tl_fd_paula', false)) {
class tl_fd_paula extends \Backend
{
