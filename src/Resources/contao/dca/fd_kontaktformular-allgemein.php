...
$GLOBALS['TL_DCA']['tl_formdata'] = [
    ...
    'list' => [
        ...
        'label' => [
            'fields' => ['date', 'form', 'alias', 'be_notes', 'anrede', 'vorname', 'name', 'email', 'message', 'DATENSCHUTZ'],
    ...
    'tl_formdata' => [
        ...
        'detailFields' => ['anrede', 'vorname', 'name', 'email', 'message', 'DATENSCHUTZ'],
        'formFilterKey' => 'form',
...
// 'message'
$GLOBALS['TL_DCA']['tl_formdata']['fields']['message']['label'] = ['text', '[message] text'];
...
// 'DATENSCHUTZ'
$GLOBALS['TL_DCA']['tl_formdata']['fields']['DATENSCHUTZ']['label'] = ['DATENSCHUTZ', '[DATENSCHUTZ] '];
