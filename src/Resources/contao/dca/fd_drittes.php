...
// last created on 2021-03-02 15:40:41 by saving form "Drittes"



/**
 * Table tl_formdata defined by form "Drittes"
 */
...
(
	...
	<div class="fd_head">%s<span>[%s]</span><span>%s</span></div>
		<div class="fd_notes">%s</div>
			...
			/*
			'label_callback'          => array('tl_fd_drittes','getRowLabel')
			*/
		),
 ...
 */
if (!class_exists('tl_fd_drittes', false)) {
class tl_fd_drittes extends \Backend
{
